...
extern "C" {
	 ...
	 */
	DLLEXPORT int CALLCONVENTION tqsl_init(void);
	 ...
	 */
	DLLEXPORT const char* CALLCONVENTION tqsl_getErrorString(void);
...
#define TQSL_LOCATION_FIELD_INT 2	///< Integer field
	 ...
	 */
	DLLEXPORT int CALLCONVENTION tqsl_clearCabrilloMap(void);
	 ...
	 */
	DLLEXPORT int CALLCONVENTION tqsl_clearADIFModes(void);
